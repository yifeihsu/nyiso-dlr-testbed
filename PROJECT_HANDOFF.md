...
**Independent generation update — 2026-09-08:** [Source reconstruction and unseen-hour results](COMPACT_NY_GENERATION_RECONSTRUCTION.md) adds an optional `npcc_ny_2025_source_generation` operating case on the same 66-bus geometry. Four reserved hours have interface MAE 134–185 benchmark MW; 14/14 source-qualified snapshots pass bounded AC and fresh replay. Two hours are explicitly skipped for boundary-data gaps. Generation is independently estimated, not observed zonal telemetry. The original electrical/thermal loaders and preferred configuration remain preserved. The [infrastructure status audit](output/compact_ny_2025/sources/INFRASTRUCTURE_2025_STATUS_AUDIT.md) corrects the blanket Smart Path Connect exclusion: some equipment entered service in late 2025. Its proposed approximately 71-bus alternative is not implemented or numerically qualified yet.
