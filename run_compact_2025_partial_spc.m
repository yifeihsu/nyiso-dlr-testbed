...
for file=["run_compact_2025_partial_spc.m";"replay_compact_2025_partial_spc.m"; ...
        ...
        "System Matpower Format/NY_Lite/fit_compact_partial_spc_operating_snapshot.m"; ...
        "System Matpower Format/NY_Lite/test_compact_partial_spc_strict_ipopt.m"; ...
...
for v=1:height(variants)
    ...
    for k=1:numel(study_ids)
        ...
        for s=1:numel(solvers)
            try
                fit=fit_compact_partial_spc_operating_snapshot(snapshot,struct('fit_interfaces',false, ...
...
out=struct('modern_build',builds{1},'builds',{builds},'cases',{cases},'case_summary',summary, ...
    ...
    'solver_policy',"unchanged_MIPS_first_then_IPOPT_1e-11_tolerances_no_acceptable_termination_1000_iteration_cap_after_physical_failure", ...
