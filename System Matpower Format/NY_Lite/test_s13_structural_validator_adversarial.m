...
mutation_id = [ ...
    ...
    "s13_model_role_changed"; ...
    "s13_current_phase_mismatch"; ...
    "phase1b_placeholder_report"; ...
    "phase_report_nonkey_diverged"; ...
    "phase_reports_missing"; ...
    "phase1a_alias_diverged"; ...
    "s13_metadata_schema_changed"; ...
    "s13_construction_source_claimed"; ...
    "s13_promotion_claimed"; ...
    "s13_current_phase_vector"; ...
    "s13_governing_role_vector"; ...
...
switch mutation_id
    ...
    case "source_branch_row_changed"
        ...
        candidate.userdata.s13.overlay_report.branch_map = map;
    ...
    case "phase1b_placeholder_report"
        ...
        candidate.userdata.s13.phase_reports.phase1b = ...
            struct('phase_id', 'phase1b');
    case "phase_report_nonkey_diverged"
        report = candidate.userdata.s13.overlay_report;
        report.phase_id = 'phase1b';
        report.branch_map.source_model(1) = ...
            "npcc_ny_lite_s12_perform_retention_core";
        candidate.userdata.s13.current_phase = 'phase1b';
        candidate.userdata.npcc_perform_overlay.current_phase = 'phase1b';
        candidate.userdata.s13.phase_reports.phase1b = report;
    case "phase_reports_missing"
        candidate.userdata.s13 = rmfield(candidate.userdata.s13, ...
            'phase_reports');
    case "phase1a_alias_diverged"
        map = candidate.userdata.s13.phase1a_report.branch_map;
        map.source_branch_row(1) = map.source_branch_row(1) + 1;
        candidate.userdata.s13.phase1a_report.branch_map = map;
    case "s13_metadata_schema_changed"
        candidate.userdata.s13.metadata_schema_version = 3;
    case "s13_construction_source_claimed"
        candidate.userdata.s13.construction_source_qualified = true;
    case "s13_promotion_claimed"
        candidate.userdata.s13.promotion_eligible = true;
    case "s13_current_phase_vector"
        candidate.userdata.s13.current_phase = ["phase1a","phase1b"];
    case "s13_governing_role_vector"
        candidate.userdata.s13.governing_hierarchy_role = [ ...
            "s13_full_construction_validation_parent", "unexpected_role"];
    otherwise
...
truncated = base.userdata.s13.overlay_report.physical_register;
