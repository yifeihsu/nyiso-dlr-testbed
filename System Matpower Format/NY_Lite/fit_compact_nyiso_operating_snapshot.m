function out=fit_compact_nyiso_operating_snapshot(snapshot,options)
%FIT_COMPACT_NYISO_OPERATING_SNAPSHOT Bounded AC fit with heldout separation.
...
solver_error="";r=m;r.success=false;r.branch(:,PF:QT)=0;
try
