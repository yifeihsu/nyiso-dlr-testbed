...
%   Rebuilds/loads the unpromoted S13 candidate and compares the five
...
%   must all match. The default behavior is fail-closed.
...
all_artifacts_match = height(checks) == 5 && all(checks.pass);
